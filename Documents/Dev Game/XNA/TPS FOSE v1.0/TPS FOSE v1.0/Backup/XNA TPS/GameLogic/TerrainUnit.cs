...
namespace XNA_TPS.GameLogic
{
    public class TerrainUnit : DrawableGameComponent
    {
        ...
        public override void Update(GameTime time)
        {
            ...
            if (Transformation.Translate.X > 1000 || Transformation.Translate.X < -1000 || Transformation.Translate.Z < -1000 || Transformation.Translate.Z > 1000)
                Transformation.Translate = new Vector3(800 - RandomHelper.GetRandomInt(1600), 0, 800 - RandomHelper.GetRandomInt(1600));
